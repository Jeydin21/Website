...
export default function ButtonsContainer() {
  return (
    <div className="flex flex-row justify-center text-sm text-red-400 dark:text-red-300">
      <a className="no-underline text-yellow-300" target="_blank" href="mailto:jeydin@j21.dev">
        <div className="p-2 duration-300 text-[3em] hover:-translate-y-2 hover:scale-105" aria-hidden="true"
          title="Email">
          <FaRegEnvelope />
        </div>
      </a>
      ...
      <a className="no-underline text-white" target="_blank" href="https://github.com/Jeydin21">
        <div className="p-2 duration-300 text-[3em] hover:-translate-y-2 hover:scale-105" aria-hidden="true"
          title="GitHub">
          <FaGithub />
        </div>
